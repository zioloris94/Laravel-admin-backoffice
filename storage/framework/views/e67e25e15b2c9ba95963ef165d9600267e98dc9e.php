...
<table class="table">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr id="task<?php echo e($task->admin_id); ?>">
            <td><?php echo e($task->cod_agente); ?></td>
            <td><?php echo e($task->des_ragsoc); ?></td>
            <td><?php echo e($task->des_email); ?></td>
            <td> Cliente Pippo</td>
            <td>

                <button class="btn btn-info" data-toggle="modal" data-target="#viewModal" onclick="fun_view('<?php echo e($task -> admin_id); ?>')">Dettagli</button>
                <button class="btn btn-warning" data-toggle="modal" data-target="#editModal" onclick="fun_edit('<?php echo e($task -> admin_id); ?>')">Edit</button>
                <button class="btn btn-danger" data-target="#myModal2" onclick="fun_delete('<?php echo e($task -> admin_id); ?>')">Delete</button>
...
<input type="hidden" name="hiddens" id="hiddens" value="<?php echo e(url('searchagenti')); ?>">
